      ...
      <header className="pt-16 flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
        <div className="max-w-3xl text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-700 max-w-2xl mx-auto leading-relaxed">
            Discover local vendors, products, and services powered by intelligent search and personalized recommendations. Your neighborhood, smarter.
          </p>
      ...
      <section className="py-12 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            {[
              { icon: "🔍", title: "AI-Powered Search", desc: "Find vendors and products near you instantly with our advanced AI algorithms that understand your needs." },
              { icon: "✅", title: "Verified Vendors", desc: "All vendors are thoroughly verified to ensure quality, trustworthiness, and reliable service delivery." },
              { icon: "⚡", title: "Lightning Fast", desc: "Experience seamless, fast, and user-friendly interface optimized for both mobile and desktop devices." }
            ].map((feature, index) => (
              <div key={index} className="bg-gradient-to-br from-gray-50 to-white p-6 sm:p-8 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
