      ...
      <div className="min-h-screen bg-gradient-to-br from-teal-50 to-cyan-50 px-4 sm:px-6 lg:px-8 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-10 text-center">
            ...
            <button className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white px-6 sm:px-8 py-3 rounded-xl font-semibold hover:from-teal-700 hover:to-cyan-700 transition-all duration-300 text-sm sm:text-base">
              Request a Service
            </button>
          </div>
        </div>
